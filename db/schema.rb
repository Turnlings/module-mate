...
ActiveRecord::Schema[7.2].define(version: 2026_03_15_151844) do
  ...
  create_table "timelogs", force: :cascade do |t|
    ...
    t.index ["user_id", "uni_module_id", "date"], name: "index_timelogs_on_user_id_and_uni_module_id_and_date"
